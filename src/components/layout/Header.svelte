<div class="navbar bg-base-100 relative z-50">
    <div class="navbar-start">
        ...
        <!-- Logo -->
        <a href="/" class="text-xl"><img src="/media/branding/lucci-logo.png" alt="Logo de Lucci" width="150px"></a>
    </div>
        ...
        <ul class="menu menu-horizontal px-1 gap-4">
            ...
            <li>
                <details>
                    ...
                    <ul class="p-1">
                        <li><a>Moda hombre</a></li>
                        <li><a>Polos</a></li>
                        <li><a>Pantalones</a></li>
                        <li><a>Casacas</a></li>
                        <li><a>Cinturones</a></li>
                    </ul>
                </details>
            </li>
            <li>
                <details>
                    <summary>Niñas</summary>
                    <ul class="p-1">
                        <li><a>Polos</a></li>
                        <li><a>Pantalones</a></li>
                        <li><a>Casacas</a></li>
