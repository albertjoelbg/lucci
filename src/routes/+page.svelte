...
<div class="fixed right-4 bottom-4">
    <a href="https://wa.me/987654321" target="_blank" class="btn btn-circle btn-lg bg-[#00E676]">
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 39 39"><path
